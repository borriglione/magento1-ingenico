 ...
 */
class Netresearch_OPS_Model_Backend_Parameter
{
     ...
     * @return Netresearch_OPS_Model_Backend_Parameter_Interface - the model for the parameters of the
     *      operation
     */
    protected function getParameterModel($operation)
    {
        if ($operation === Netresearch_OPS_Model_Payment_Abstract::OPS_CAPTURE_TRANSACTION_TYPE) {
            return Mage::getModel('ops/backend_capture_parameter');
        }

        if ($operation === Netresearch_OPS_Model_Payment_Abstract::OPS_REFUND_TRANSACTION_TYPE) {
            return Mage::getModel('ops/backend_refund_parameter');
        }
